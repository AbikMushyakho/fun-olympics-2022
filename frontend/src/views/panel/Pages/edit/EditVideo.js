...
import { getOne, update } from "../../../../services/video";
import { Formik } from "formik";
import TextField from "../../../../Components/TextField";
import TextArea from "../../../../Components/TextArea";
import ReactPlayer from "react-player";

const EditVideo = ({ setMessage }) => {
  const { id } = useParams();
                  ...
                  <div className="grid grid-cols-6 gap-6 ">
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <TextField
                        type="text"
                        name="category"
                        value={video.category ? video.category.title : ""}
                        disabled
                      />
                    </div>
                    <div className="col-span-6 sm:col-span-3">
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <div className="w-full max-h-fit shadow-sm bg-gray-50 border p-2 rounded-md border-gray-300 text-gray-900 sm:text-sm  focus:ring-blue-600 focus:border-blue-600   dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <ReactPlayer
                          width="100%"
                          height="100%"
                          url={video.video_url}
