      ...
      <main className="h-full w-full overflow-y-auto">
        <div className="container px-6 mx-auto grid">
          ...
          <div className="overflow-x-auto w-full shadow-md sm:rounded-lg">
            ...
            {/* <!-- Edit user modal --> */}
            <div className="block overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 md:top-40 md:left-80  z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">
              <div className="relative w-full max-w-2xl h-full md:h-auto">
                ...
                >
                  ...
                  <div className="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                    ...
                    <button className="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-500 dark:focus:ring-gray-300">
                      Cancel
                    </button>
                  </div>
                </form>
